...
fn generic_request(file: &str, key: &str, method: &str, args: Option<&str>) -> Result<String, String>{
    let file_with_ext = format!("{}{}", file, SYSTEM);
    let output = command(&file_with_ext, key, method, args);
...
pub fn check_usage(key: &str) -> Result<String, String> {
    generic_request("../src/translator/utils.", key, "check_usage", None)
}

#[tauri::command]
pub fn get_source_languages(key: &str) -> Result<String, String> {
    generic_request("../src/translator/utils.", key, "get_languages", Some("source"))
}

#[tauri::command]
pub fn get_target_languages(key: &str) -> Result<String, String> {
    generic_request("../src/translator/utils.", key, "get_languages", Some("target"))
}

#[tauri::command]
pub fn glossary_from_excel(key: &str, args: &str) -> Result<String, String> {
    generic_request("../src/translator/glossary.", key, "create_from_excel", Some(args))
}

#[tauri::command]
pub fn get_glossaries(key: &str) -> Result<String, String> {
    generic_request("../src/translator/glossary.", key, "get_glossaries", None)
}

#[tauri::command]
pub fn delete_glossary(key: &str, glossary_id: &str) -> Result<String, String> {
    generic_request("../src/translator/glossary.", key, "delete_glossary", Some(glossary_id))
}

#[tauri::command]
pub fn get_glossaries_entries(key: &str) -> Result<String, String> {
    generic_request("../src/translator/glossary.", key, "get_glossaries_entries", None)
}

#[tauri::command]
pub fn translate_document(key: &str, args: &str) -> Result<String, String> {
    generic_request("../src/translator/translate.", key, "translate_doc", Some(args))
}
...
pub fn translate_doc_alt(key: &str, file_data: Vec<u8>, file_name: &str, file_output: &str, source_language: &str, target_language: &str, glossary_id: Option<&str>) -> Result<String, String> {
    ...
    generic_request("../src/translator/translate.", key, "translate_word_preserve_format", Some(&args))
}

#[tauri::command]
pub fn translate_excel_alt(key: &str, args: &str) -> Result<String, String> {
    generic_request("../src/translator/translate.", key, "translate_excel", Some(args))
}